...
#define ae2f_BmpDotRGBAGetR(rgb) ae2f_static_cast(uint8_t, ae2f_BitVecGetRanged(ae2f_static_cast(uint32_t, rgb), 0, 8))

/// @brief
/// Gets the value of channel [G]
/// @param rgb {uint32_t} 3-channel colour integer.
#define ae2f_BmpDotRGBAGetG(rgb) ae2f_static_cast(uint8_t, ae2f_BitVecGetRanged(ae2f_static_cast(uint32_t, rgb), 8, 16))

/// @brief
/// Gets the value of channel [B]
/// @param rgb {uint32_t} 3-channel colour integer.
#define ae2f_BmpDotRGBAGetB(rgb) ae2f_static_cast(uint8_t, ae2f_BitVecGetRanged(ae2f_static_cast(uint32_t, rgb), 16, 24))

/// @brief
/// Gets the value of channel [A]
/// @param rgba {uint32_t} 4-channel colour integer.
#define ae2f_BmpDotRGBAGetA(rgba) ae2f_static_cast(uint8_t, ae2f_BitVecGetRanged(ae2f_static_cast(uint32_t, rgba), 24, 32))

/// @brief
/// Sets the value of channel [R]
/// @param rgb {uint32_t}
/// @param val The value to set
#define ae2f_BmpDotRGBASetR(rgb, val)  ae2f_static_cast(uint32_t, ae2f_BitVecSetRanged(ae2f_static_cast(uint32_t, rgb), 0, 8, val))

/// @brief
/// Sets the value of channel [G]
/// @param rgb {uint32_t}
/// @param val The value to set
#define ae2f_BmpDotRGBASetG(rgb, val)  ae2f_static_cast(uint32_t, ae2f_BitVecSetRanged(ae2f_static_cast(uint32_t, rgb), 8, 16, val))

/// @brief
/// Sets the value of channel [B]
/// @param rgb {uint32_t}
/// @param val The value to set
#define ae2f_BmpDotRGBASetB(rgb, val)  ae2f_static_cast(uint32_t, ae2f_BitVecSetRanged(ae2f_static_cast(uint32_t, rgb), 16, 24, val))

/// @brief
/// Sets the value of channel [A]
/// @param rgba {uint32_t}
/// @param val The value to set
#define ae2f_BmpDotRGBASetA(rgba, val) ae2f_static_cast(uint32_t, ae2f_BitVecSetRanged(ae2f_static_cast(uint32_t, rgba), 24, 32, val))
