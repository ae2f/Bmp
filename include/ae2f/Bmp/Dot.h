...
#define ae2f_Bmp_Dot_RGBA_SetR(rgb, val) ae2f_Macro_BitVector_SetRanged(ae2f_static_cast(uint32_t, rgb), 0, 8, val)
#define ae2f_Bmp_Dot_RGBA_SetG(rgb, val) ae2f_Macro_BitVector_SetRanged(ae2f_static_cast(uint32_t, rgb), 8, 16, val)
#define ae2f_Bmp_Dot_RGBA_SetB(rgb, val) ae2f_Macro_BitVector_SetRanged(ae2f_static_cast(uint32_t, rgb), 16, 24, val)
#define ae2f_Bmp_Dot_RGBA_SetA(rgba, val) ae2f_Macro_BitVector_SetRanged(ae2f_static_cast(uint32_t, rgba), 24, 32, val)
